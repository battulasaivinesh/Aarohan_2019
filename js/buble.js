...
animate = function() {
  ...
  $(".fluid").animate(
    {
      ...
      backgroundColor: rgb2hex("rgba(" + 232 + "," + 148 + ", 40)")
    },
    anim_duration,
    animate
  );
  ...
  $(".fluidbig").animate(
    {
      borderTopLeftRadius: String(
        Math.round(Math.random() * randomness2 + threshold2) + "px"
      ),
      borderTopRightRadius: String(
        Math.round(Math.random() * randomness2 + threshold2) + "px"
      ),
  ...
  $(".fluiddark").animate(
    {
      borderTopLeftRadius: String(
        Math.round(Math.random() * randomness3 + threshold3) + "px"
      ),
      borderTopRightRadius: String(
        Math.round(Math.random() * randomness3 + threshold3) + "px"
      ),
      ...
      backgroundColor: rgb2hex(
        "rgba(" + randomNumBlack + "," + randomNumGrey + ", 215)"
      )
    },
    anim_duration3,
    animate
