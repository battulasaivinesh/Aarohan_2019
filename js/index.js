...
(function($) {
  ...
  $("#Проекты, #mobiПроекты").click(function(e) {
    ...
    $(".projectsMenu__leftPart__closeBlock").css(
      "width",
      leftCloseBlock + "px"
    );
  ...
  $(
    ".projectsMenu__leftPart__close, .projectsMenu__rightPart__close, .projectsMenu__leftPart__closeBlock"
  ).click(function() {
    ...
    $(
      ".projectsMenu__rightPart__fotoProjects, .projectsMenu__rightPart__nameProjects"
    ).animate(
      {
        opacity: 0
      },
  ...
  function stopMenuProjectImageAnimation() {
    $(".projectsMenu__rightPart__fotoProjects-wrapImg")
      .stop()
      .animate(
        {
          width: 0
  ...
  $(".projectsMenu__rightPart__nameProjects-category li").hover(function() {
    //Получаем высоту экрана
    var heightWindowMenuHalf = $(window).height() / 2;
    var top_offset = $("#mCSB_1_container").offset().top;
    var heightObjectMenuHalf =
      $(".projectsMenu__rightPart__nameProjects-category-img").height() / 2;
    ...
    if (imgMenu.width() > 0) {
      imgMenu.stop().animate(
        ...
        600,
        function() {
          startMenuProjectImageAnimation(
            pathImgPoroject,
            topObjectMenu,
            randomLeft
          );
...
$(document).ready(function() {
  ...
  $(".projectMainSliderMobi__project-1").append(
    '<div class="blockBgSliderItem"></div>'
  );
  ...
  if (width_display_device < 769) {
    ...
    $(".projectMainSliderMobi__bgBlock").css(
      "transform",
      "translateX(" + widthBlockOne + "px)"
    );
